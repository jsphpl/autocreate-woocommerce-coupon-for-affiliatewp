...
Install via the "Install New" function in WordPress
...
= Can i set the type and value of the created coupon? =

Yes. In the plugin settings you can choose between cart discount (fixed) and cart discount (percent) and set the corresponding value.
